...
The `Build and deploy` GitHub Actions workflow (`.github/workflows/deploy.yml`) publishes immutable SHA-tagged backend and frontend images to GitHub Container Registry on `main`, plus `latest` tags for convenience.
